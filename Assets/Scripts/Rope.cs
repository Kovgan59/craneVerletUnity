...
public class Rope : MonoBehaviour 
{
    ...
    [SerializeField] Transform whatTheRopeIsConnectedTo;
    [SerializeField] Transform whatIsHangingFromTheRope;
    
    [SerializeField] int ropeLength;
    [SerializeField] float ropeSectionLength = 0.1f;
    private int ropeLengthTemp;
    ...
    private void Start() 
	{
        ...
        ropeLengthTemp = ropeLength;
    }
	
	private void Update()
	{
        if (ropeLengthTemp != ropeLength)
        {
